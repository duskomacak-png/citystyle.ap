...
async function showAddProductForm(productId = null) {
  ...
  box.innerHTML = `<div class="card product-edit-card"><h3>${product ? "Uredi oglas / proizvod" : "Novi oglas / proizvod"}</h3>
    ...
    <p class="field-help product-upload-tip"><strong>Preporuka za najbolji prikaz:</strong> koristite uspravne slike odnosa <strong>6:19</strong>. Takve slike najlepše popunjavaju ekran telefona i izgledaju najbolje kada klijent otvori oglas.</p>
